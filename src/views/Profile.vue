<template>
    ...
    <div class="px-8">
      <ul>
        <div class="flex justify-between">
          <div>
            <li class="pb-4 font-bold">John Doe</li>
          </div>
          <div class="flex">
            <div class="mr-4">
              <svg
                ...
                data-prefix="fas"
                data-icon="envelope"
                class="svg-inline--fa fa-envelope w-5 h-5"
                role="img"
            ...
            <div>
              <svg
                ...
                data-prefix="fas"
                data-icon="phone"
                class="svg-inline--fa fa-phone w-5 h-4"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
 ...
 <div class="flex justify-between">
          <div>
            <li class="pb-4 font-bold">Natalie Aronavo</li>
          </div>
          <div class="flex">
            <div class="mr-4">
              <svg
 ...
 <div class="flex justify-between">
          <div>
            <li class="pb-4 font-bold">Daniel Gibson</li>
          </div>
          <div class="flex">
            <div class="mr-4">
              <svg
